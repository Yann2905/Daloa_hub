...
export function BarChart({
  ...
  return (
    <div className="overflow-hidden rounded-xl border bg-card p-4 shadow-soft">
      {title && (
      ...
      <div className="flex h-32 items-end gap-1">
        {data.map((d, i) => (
          <div
            key={i}
            className="group relative min-w-0 flex-1 rounded-t bg-gradient-to-t from-brand-green to-emerald-400 transition-all hover:from-brand-orange hover:to-amber-400"
